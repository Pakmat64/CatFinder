...
class App_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.M6xdXc_' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_M6xdXcService()
    {
        return $this->privates['.service_locator.M6xdXc_'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getSecurity_ContextListener_0Service()
    {
        ...
        return $this->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['security.user.provider.concrete.dans_la_database'] ?? $this->getSecurity_User_Provider_Concrete_DansLaDatabaseService());
    ...
    /**
     * Gets the private 'security.user.provider.concrete.dans_la_database' shared service.
     *
     * @return \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider
     */
    protected function getSecurity_User_Provider_Concrete_DansLaDatabaseService()
    {
        ...
        return $this->privates['security.user.provider.concrete.dans_la_database'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'App\\Entity\\User', 'email', NULL);
    }
