...
/* liste_race/raceChatE.html.twig */
class __TwigTemplate_f9ade5b4bdb368cfc757c57cc3d1bf6d183d4065f7d585b69c4801d974a22932 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "liste_race/raceChatE.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "liste_race/raceChatE.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "liste_race/raceChatE.html.twig", 1);
...
<div class=\"container\">
    ...
    <div class=\"container\">
        <h1 class=\"my-3\">Voici les races de chats :</h1>
           ";
        // line 41
        if (0 === twig_compare(twig_length_filter($this->env, (isset($context["racesE"]) || array_key_exists("racesE", $context) ? $context["racesE"] : (function () { throw new RuntimeError('Variable "racesE" does not exist.', 41, $this->source); })())), 0)) {
            // line 42
            echo "        
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["racesE"]) || array_key_exists("racesE", $context) ? $context["racesE"] : (function () { throw new RuntimeError('Variable "racesE" does not exist.', 48, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["raceE"]) {
                // line 49
                echo "
...
\t\t                <div class=\"card-header text-center\"><strong>";
                // line 52
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["raceE"], "libelle", [], "any", false, false, false, 52), "html", null, true);
                echo "</strong>
\t\t                </div>
                            <div class=\"card-body\">
\t\t                       <img src= \"";
                // line 55
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["raceE"], "urlImage", [], "any", false, false, false, 55), "html", null, true);
            ...
            unset($context['_seq'], $context['_iterated'], $context['_key'], $context['raceE'], $context['_parent'], $context['loop']);
...
";
    ...
    {
        return "liste_race/raceChatE.html.twig";
    }
    ...
    {
        return array (  226 => 62,  222 => 60,  211 => 55,  205 => 52,  200 => 49,  196 => 48,  191 => 45,  186 => 42,  184 => 41,  174 => 34,  170 => 33,  166 => 32,  162 => 31,  158 => 30,  154 => 29,  150 => 28,  146 => 27,  142 => 26,  138 => 25,  134 => 24,  130 => 23,  126 => 22,  122 => 21,  118 => 20,  114 => 19,  110 => 18,  106 => 17,  102 => 16,  98 => 15,  94 => 14,  90 => 13,  86 => 12,  82 => 11,  78 => 10,  74 => 9,  68 => 5,  58 => 4,  35 => 1,);
    }
        ...
        <h1 class=\"my-3\">Voici les races de chats :</h1>
           {% if racesE| length == 0 %}
            ...
            {% for raceE in racesE %}
                ...
                <div class =\"col-md-4 mb-3\">
\t                <div class=\"card border-dark mb-3\">
\t\t                <div class=\"card-header text-center\"><strong>{{raceE.libelle}}</strong>
\t\t                </div>
                            <div class=\"card-body\">
\t\t                       <img src= \"{{raceE.urlImage}}\" alt=\"Image de chat\" style=\"height:200px; width:100%; display:block\">\t
                            </div>                     
                    </div>
                 </div>   
            {% endfor %}
...
{% endblock %}
", "liste_race/raceChatE.html.twig", "C:\\Users\\Bobo\\ProjetChat\\templates\\liste_race\\raceChatE.html.twig");
    }
}
