...
/* liste_race/raceChatA.html.twig */
class __TwigTemplate_19b645264755b90b02320b9ea0d2c29902f4e1eb755ff8f1664b9ce106b2c092 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "liste_race/raceChatA.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "liste_race/raceChatA.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "liste_race/raceChatA.html.twig", 1);
...
<div class=\"container\">
    ...
    <div class=\"container\">
        <h1 class=\"my-3\">Voici les races de chats :</h1>
         ...
         ";
        // line 42
        if (0 === twig_compare(twig_length_filter($this->env, (isset($context["racesA"]) || array_key_exists("racesA", $context) ? $context["racesA"] : (function () { throw new RuntimeError('Variable "racesA" does not exist.', 42, $this->source); })())), 0)) {
            // line 43
            echo "        
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["racesA"]) || array_key_exists("racesA", $context) ? $context["racesA"] : (function () { throw new RuntimeError('Variable "racesA" does not exist.', 49, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["raceA"]) {
                // line 50
                echo "
...
\t\t                <div class=\"card-header text-center\"><strong>";
                // line 53
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["raceA"], "libelle", [], "any", false, false, false, 53), "html", null, true);
                echo "</strong>
\t\t                </div>
                            <div class=\"card-body\">
\t\t                       <img src= \"";
                // line 56
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["raceA"], "urlImage", [], "any", false, false, false, 56), "html", null, true);
            ...
            unset($context['_seq'], $context['_iterated'], $context['_key'], $context['raceA'], $context['_parent'], $context['loop']);
...
";
    ...
    {
        return "liste_race/raceChatA.html.twig";
    }
        ...
        <h1 class=\"my-3\">Voici les races de chats :</h1>
         ...
         {% if racesA | length == 0 %}
            ...
            {% for raceA in racesA %}
                ...
                <div class =\"col-md-4 mb-3\">
\t                <div class=\"card border-dark mb-3\">
\t\t                <div class=\"card-header text-center\"><strong>{{raceA.libelle}}</strong>
\t\t                </div>
                            <div class=\"card-body\">
\t\t                       <img src= \"{{raceA.urlImage}}\" alt=\"Image de chat\" style=\"height:200px; width:100%; display:block\">\t
                            </div>                     
                    </div>
                 </div>   
            {% endfor %}
...
{% endblock %}
", "liste_race/raceChatA.html.twig", "C:\\Users\\Bobo\\ProjetChat\\templates\\liste_race\\raceChatA.html.twig");
    }
}
